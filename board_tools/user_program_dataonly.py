...
class UserProgram:
    ...
    def show_info(self):
        ...
        print("\nSystem Status:")
        #self.show_device() # this is just blank if no config connection
    ...
    def monitor_main(self):
        ...
        buttons_row = [log_button, time_since_gps_label, time_since_gps, anello_logo]
        ...
        if not self.show_gps_info:
            for clickable_item in [ins_tab, gps_tab, gp2_tab, hdg_tab, map_tab]:
