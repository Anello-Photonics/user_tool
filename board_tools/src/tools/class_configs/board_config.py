...
ALLOWED_BAUD = [921600, 230400, 19200, 460800, 115200, 57600]  # order to try, most common first for speed
ALLOWED_BAUDS_SORTED = sorted(ALLOWED_BAUD, key=lambda x: -x)  # in high-low order, for menus
