...
RTCM_MESSAGE_TYPES = [RTCM_MSGTYPE_IMU, RTCM_MSGTYPE_GPS, RTCM_MSGTYPE_HEADING, RTCM_MSGTYPE_INS, RTCM_MSGTYPE_BIAS,
...
RTCM_BIAS_PAYLOAD_FIELDS = [
    ("imu_time_ns", "Q"),
    ("accel_x_bias_g", "i", 1e-4),
    ("accel_y_bias_g", "i", 1e-4),
    ("accel_z_bias_g", "i", 1e-4),
    ("rate_x_bias_dps", "i", 1e-5),
    ("rate_y_bias_dps", "i", 1e-5),
    ("rate_z_bias_dps", "i", 1e-5),
]